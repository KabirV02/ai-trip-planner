...
Generate a travel plan in which suggest hotels at least 5 and itinerary according to noOfDays  in strict JSON format only. Do not include markdown syntax, commentary, or code blocks.
